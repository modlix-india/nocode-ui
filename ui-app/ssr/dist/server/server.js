...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-F0coDUw7.js");
...
const manifest = { "05b41f6f8aa2632b11ea197ed3a3b6672085e9fcbafb9e30e264c1e0d5134c10": {
  functionName: "getPageData_createServerFn_handler",
  importer: () => import("./assets/_-CBH5YcIC.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-wCTnV4Zh.js").then((n) => n.r);
