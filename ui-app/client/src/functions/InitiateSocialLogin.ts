...
const SIGNATURE = new FunctionSignature('InitiateSocialLogin')
	...
	.setParameters(
		new Map([
			...
			Parameter.ofEntry(
				'businessClient',
				Schema.ofBoolean('businessClient').setDefaultValue(true),
			),
		]),
	)
	.setEvents(
...
export class InitiateSocialLogin extends AbstractFunction {
	protected async internalExecute(context: FunctionExecutionParameters): Promise<FunctionOutput> {
		...
		const businessClientArg: boolean = args?.get('businessClient');
