...
export const RenderEngineContainer = () => {
	...
	if (currentPageName && pageDefinition) {
		...
		if (wrapShell && shellPageDefinition) return <Page definition={shellPageDefinition} context="global" />;

		return <Page definition={pageDefinition} context={currentPageName} />;
	} else {
		...
		return <Page definition={shellPageDefinition} context="global" />;
	}
};
