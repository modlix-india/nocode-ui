...
// 		? regexResult[1]
// 		: location.substring(1, location.indexOf('/', 1) === -1 ? location.length : location.indexOf('/', 1));
// 	if (pagename === '/') pagename = '';
// 	const index = regexResult ? regexResult.index + 6 + pagename.length + 1 : pagename.length + 2;
...
// 		appDetails.length > 1 ? ([appname, clientcode] = appDetails) : ([appname] = appDetails);
// 	}
// 	return {
// 		appname,
// 		clientcode,
