...
export function Dropdown({
	...
	const setCurrentOption = (num: number) => {
		...
		const options = ddBody.current.querySelectorAll('._simpleFillerPickerDropdownOption');
	...
	if (open) {
		...
		body = (
			<div className="_simpleFillerPickerDropdownBody" ref={ddBody} style={dropdownBodyStyle}>
				{options.map((o, i) => (
					<div
						key={o.name}
