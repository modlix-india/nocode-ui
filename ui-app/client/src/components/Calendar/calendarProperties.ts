...
const propertiesDefinition: Array<ComponentPropertyDefinition> = [
	...
	},
	{
		...
		enumValues: [
			...
			},
			{
				...
				displayName: 'Dropdown Calendar',
				description: 'Calendar with dropdowns for date and time selection',
			},
		],
	},
	{
	...
	},
	{
		...
		description: 'Layout for date and time dropdowns',
		...
		enumValues: [
			{
				...
				description: 'All dropdowns in one row',
			},
			{
				name: 'twoRows',
	...
	{
		name: 'reverseYearOrder',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Reverse Year Order',
		description: 'Show years in descending order.',
		defaultValue: false,
		group: ComponentPropertyGroup.ADVANCED,
	},
	{
		name: 'reverseMonthOrder',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Reverse Month Order',
		description: 'Show months in descending order.',
		defaultValue: false,
		group: ComponentPropertyGroup.ADVANCED,
	},
	{
		name: 'reverseDayOrder',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Reverse Day Order',
		description: 'Show days in descending order.',
		defaultValue: false,
		group: ComponentPropertyGroup.ADVANCED,
	},
	{
		name: 'reverseHourOrder',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Reverse Hour Order',
		description: 'Show hours in descending order.',
		defaultValue: false,
		group: ComponentPropertyGroup.ADVANCED,
	},
	{
		name: 'reverseMinuteOrder',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Reverse Minute Order',
		description: 'Show minutes in descending order.',
		defaultValue: false,
		group: ComponentPropertyGroup.ADVANCED,
	},
	{
		name: 'reverseSecondOrder',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Reverse Second Order',
		description: 'Show seconds in descending order.',
		defaultValue: false,
		group: ComponentPropertyGroup.ADVANCED,
	},
];
