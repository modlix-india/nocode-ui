...
const propertiesDefinition: Array<ComponentPropertyDefinition> = [
	...
	{
		name: 'showThumbnailFeature',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Thumbnail Feature',
		description: 'Whether show Thumbnail feature in toolbar or not.',
		group: ComponentPropertyGroup.BASIC,
		defaultValue: true,
	},
	...
	{
		name: 'showPreviewFeature',
		schema: SCHEMA_BOOL_COMP_PROP,
		displayName: 'Preview Feature',
		description: 'Whether show Preview feature in toolbar or not.',
		group: ComponentPropertyGroup.BASIC,
		defaultValue: true,
	},
