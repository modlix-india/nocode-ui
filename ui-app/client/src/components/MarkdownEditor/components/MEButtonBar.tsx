	...
	return (
		<>
			...
			>
				...
				<button
					onClick={() => onModeChange('editDoc')}
					style={styleProperties.button ?? {}}
					className={`_button ${mode === 'editDoc' ? 'active' : ''}`}
					title="Edit Text"
				>
					<svg width="32" height="20.29" viewBox="0 0 32 20.29">
						<g transform="translate(-1334 -626)">
							<path
								d="M-116,210.29c-8.449,0-13.718-6.218-15.591-8.891a2.181,2.181,0,0,1-.41-1.253,2.186,2.186,0,0,1,.4-1.255c1.851-2.673,7.075-8.89,15.6-8.89s13.75,6.217,15.6,8.89a2.181,2.181,0,0,1,.4,1.255,2.181,2.181,0,0,1-.41,1.253C-102.283,204.072-107.553,210.29-116,210.29Zm-.84-17.8c-4.687,0-8.5,3.341-8.5,7.447s3.813,7.447,8.5,7.447,8.5-3.341,8.5-7.447S-112.153,192.486-116.84,192.486Z"
								transform="translate(1466 436)"
								fill="currentColor"
							/>
							<path
								...
								transform="translate(1342.432 630.419)"
								fill="currentColor"
							/>
						</g>
					</svg>
