			...
			icon: (
				<IconHelper viewBox="0 0 30 30">
					<rect
						...
						fill="url(#paint0_linear_3818_9809)"
					/>
					<path
						className="_KIRunEditorPipeline"
						d="M8 11V22C8 22.5523 8.44772 23 9 23H18"
						stroke="black"
						fillOpacity={0}
						strokeOpacity="0.3"
						strokeWidth="0.75"
					...
					/>
					<path
						className="_KIRunEditorDevice"
						d="M4.375 4C3.6166 4 3 4.6166 3 5.375V6.75C3 7.5084 3.6166 8.125 4.375 8.125H12.625C13.3834 8.125 14 7.5084 14 6.75V5.375C14 4.6166 13.3834 4 12.625 4H4.375ZM10.3906 5.54688C10.5274 5.54688 10.6585 5.6012 10.7552 5.6979C10.8519 5.7946 10.9062 5.92575 10.9062 6.0625C10.9062 6.19925 10.8519 6.3304 10.7552 6.4271C10.6585 6.5238 10.5274 6.57812 10.3906 6.57812C10.2539 6.57812 10.1227 6.5238 10.026 6.4271C9.92933 6.3304 9.875 6.19925 9.875 6.0625C9.875 5.92575 9.92933 5.7946 10.026 5.6979C10.1227 5.6012 10.2539 5.54688 10.3906 5.54688ZM11.4219 6.0625C11.4219 5.92575 11.4762 5.7946 11.5729 5.6979C11.6696 5.6012 11.8007 5.54688 11.9375 5.54688C12.0743 5.54688 12.2054 5.6012 12.3021 5.6979C12.3988 5.7946 12.4531 5.92575 12.4531 6.0625C12.4531 6.19925 12.3988 6.3304 12.3021 6.4271C12.2054 6.5238 12.0743 6.57812 11.9375 6.57812C11.8007 6.57812 11.6696 6.5238 11.5729 6.4271C11.4762 6.3304 11.4219 6.19925 11.4219 6.0625ZM4.375 9.5C3.6166 9.5 3 10.1166 3 10.875V12.25C3 13.0084 3.6166 13.625 4.375 13.625H12.625C13.3834 13.625 14 13.0084 14 12.25V10.875C14 10.1166 13.3834 9.5 12.625 9.5H4.375ZM10.3906 11.0469C10.5274 11.0469 10.6585 11.1012 10.7552 11.1979C10.8519 11.2946 10.9062 11.4257 10.9062 11.5625C10.9062 11.6993 10.8519 11.8304 10.7552 11.9271C10.6585 12.0238 10.5274 12.0781 10.3906 12.0781C10.2539 12.0781 10.1227 12.0238 10.026 11.9271C9.92933 11.8304 9.875 11.6993 9.875 11.5625C9.875 11.4257 9.92933 11.2946 10.026 11.1979C10.1227 11.1012 10.2539 11.0469 10.3906 11.0469ZM11.5938 11.5625C11.5938 11.4257 11.6481 11.2946 11.7448 11.1979C11.8415 11.1012 11.9726 11.0469 12.1094 11.0469C12.2461 11.0469 12.3773 11.1012 12.474 11.1979C12.5707 11.2946 12.625 11.4257 12.625 11.5625C12.625 11.6993 12.5707 11.8304 12.474 11.9271C12.3773 12.0238 12.2461 12.0781 12.1094 12.0781C11.9726 12.0781 11.8415 12.0238 11.7448 11.9271C11.6481 11.8304 11.5938 11.6993 11.5938 11.5625Z"
						fill="url(#paint1_linear_3818_9809)"
					/>
					<path
						className="_KiranEditorDB"
						d="M17 18.6271C17.9857 19.3755 19.9966 19.7707 21.9212 19.7707C23.8458 19.7707 25.8567 19.3755 26.8425 18.6271V20.1918C26.8425 20.9354 24.7378 21.7671 21.9212 21.7671C19.1046 21.7671 17 20.9354 17 20.1918V18.6271ZM17 22.8082C17 23.5518 19.1046 24.3835 21.9212 24.3835C24.7378 24.3835 26.8425 23.5518 26.8425 22.8082V21.2435C25.8567 21.9919 23.8458 22.387 21.9212 22.387C19.9966 22.387 17.9857 21.9919 17 21.2435V22.8082ZM17 25.4247C17 26.1683 19.1046 27 21.9212 27C24.7378 27 26.8425 26.1683 26.8425 25.4247V23.86C25.8567 24.6084 23.8458 25.0035 21.9212 25.0035C19.9966 25.0035 17.9857 24.6084 17 23.86V25.4247ZM26.8425 17.5753C26.8425 16.8317 24.7378 16 21.9212 16C19.1046 16 17 16.8317 17 17.5753C17 18.319 19.1046 19.1507 21.9212 19.1507C24.7378 19.1507 26.8425 18.319 26.8425 17.5753Z"
						fill="url(#paint2_linear_3818_9809)"
					/>
					<defs>
						<linearGradient
							id="paint0_linear_3818_9809"
							x1="15"
							y1="30"
							x2="15"
							y2="60"
						...
						<linearGradient
							...
							gradientUnits="userSpaceOnUse"
						>
							<stop stopColor="#8EDEF9" />
							<stop offset="1" stopColor="#61A3BA" />
						</linearGradient>
						<linearGradient
							id="paint2_linear_3818_9809"
							x1="21.9212"
							y1="16"
							x2="21.9212"
							y2="27"
