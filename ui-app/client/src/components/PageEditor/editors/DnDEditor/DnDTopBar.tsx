		...
		<div className="_topBarGrid">
			...
			<div className="_topRightBarGrid">
				<div className="_tabContainer">
					<div
						className="_tab _reload"
						onClick={onPageReload}
						onKeyDown={e => (e.key === 'Enter' || e.key === ' ') && onPageReload?.()}
					>
					...
					<div className="_tab _selected _iconMenu _personalize">
						<IconHelper viewBox="0 0 20 20">
							<path
								...
								fill="url(#paint0_linear_1540_4757)"
							/>
							<defs>
								<linearGradient
									id="paint0_linear_1540_4757"
									x1="10"
									y1="0"
									x2="10"
									y2="20"
