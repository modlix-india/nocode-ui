...
function BorderStandardEditor({
	...
	useEffect(() => {
		...
		if (
			!borderRadiusValueBag.TopLeft &&
			!borderRadiusValueBag.TopRight &&
			!borderRadiusValueBag.BottomLeft &&
			!borderRadiusValueBag.BottomRight
		) {
		...
		if (
			...
			for (const direction of ['TopRight', 'BottomLeft', 'BottomRight']) {
				if (borderRadiusValueBag[direction] !== borderRadiusValueBag.TopLeft) {
					setBorderRadiusMode([BorderRadiusMode.ALL]);
					return;
				}
			}
		...
		if (borderRadiusValueBag.TopLeft) setBorderRadiusMode([BorderRadiusMode.TOP_LEFT]);
		else if (borderRadiusValueBag.TopRight) setBorderRadiusMode([BorderRadiusMode.TOP_RIGHT]);
		else if (borderRadiusValueBag.BottomLeft)
			setBorderRadiusMode([BorderRadiusMode.BOTTOM_LEFT]);
		else setBorderRadiusMode([BorderRadiusMode.BOTTOM_RIGHT]);
	...
	const onChangeBorderRadius = (value: string) => {
		...
		if (borderRadiusMode.includes(BorderRadiusMode.ALL)) {
			...
			for (const mode of borderRadiusMode)
				newValues.push({ prop: 'border' + mode + 'Radius', value });
		}
	...
	const borderRadius =
		(borderRadiusMode.includes(BorderRadiusMode.ALL)
			? borderRadiusValueBag.TopLeft
		...
		<>
			...
			<div className="_simpleEditor">
				<IconsSimpleEditor
					...
					exclusiveOptions={[BorderMode.ALL]}
					combinationOptions={[
						{
							condition: [
								BorderMode.BOTTOM,
			...
			<div className="_simpleEditor">
				<IconsSimpleEditor
					...
					multiSelectWithControl={true}
					withBackground={true}
					onChange={v => setBorderRadiusMode(v as BorderRadiusMode[])}
					exclusiveOptions={[BorderRadiusMode.ALL]}
					combinationOptions={[
						{
							condition: [
								BorderRadiusMode.TOP_LEFT,
								BorderRadiusMode.BOTTOM_LEFT,
								BorderRadiusMode.TOP_RIGHT,
								BorderRadiusMode.BOTTOM_RIGHT,
							],
							name: [BorderRadiusMode.ALL],
						},
					]}
				/>
			</div>
