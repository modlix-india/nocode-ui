...
const propertiesDefinition: Array<ComponentPropertyDefinition> = [
	...
	},
	{
		...
		enumValues: [
			{ name: 'default', displayName: 'Default Menu', description: 'Default Menu type' },
			{ name: 'outlined', displayName: 'Outline Menu', description: 'Outline Menu type' },
			{ name: 'text', displayName: 'Text Menu', description: 'Outline Menu type' },
			{
				name: 'sides',
	...
	},
	{
		...
		enumValues: [
			...
			{ name: 'secondary', displayName: 'Outline Menu', description: 'Outline Menu type' },
			{ name: 'tertiary', displayName: 'Text Menu', description: 'Outline Menu type' },
			{
				name: 'quaternary',
				displayName: 'Side Bordered Menu',
				description: 'Side Bordered Menu type',
